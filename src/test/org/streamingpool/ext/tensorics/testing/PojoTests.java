...
public final class PojoTests {
    ...
    /**
     * it takes classes from below the given package name and taking into account the given filters. The following
     * filters are applied by default:
     * <ul>
     * <li>{@link FilterPackageInfo}: Ignores the package-info.java
     * <li>{@link PojoClassFilters#excludeTestClasses}: Ignores test classes
     ...
     * @return a list of objects, which will represent a parameter array of className - class pairs.
     */
    public static List<Class<?>> pojocClassesForPackageName(String packageName, PojoClassFilter... classFilters) {
        ...
        filters.addAll(Arrays.asList(new PojoClassFilter[] { new FilterPackageInfo(),
                PojoClassFilters.excludeTestClasses(), new FilterCloverClasses() }));
    ...
    /**
     * it takes classes from below all given package names and taking into account the given filters. This is a
     * convenience method for calling {@link #pojocClassesForPackageName(String, PojoClassFilter...)} with many package
     * names.
     *
