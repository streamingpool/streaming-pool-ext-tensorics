...
package org.streamingpool.ext.tensorics.testing;
...
public abstract class SerializableHasUid {
    ...
    public final List<Object> getParameters() {
        return PojoTests
                .pojocClassesForPackageName(packageNameToScan, PojoClassFilters.includeTypes(Serializable.class),
                        PojoClassFilters.excludeEnums(), PojoClassFilters.excludeInterfaces())
                .stream().map(c -> new Object[] { c }).collect(Collectors.toList());
    }
